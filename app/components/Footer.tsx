  ...
  return (
    <footer className="relative" style={{ background: "#080808" }}>
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <a
              ...
              className="flex items-center gap-3 text-cream-dim hover:text-copper transition-all duration-300 text-sm group mt-1"
            >
          ...
          <div className="flex flex-col gap-4 md:items-end">
            ...
            <div className="flex flex-col gap-2 text-cream-dim text-sm md:text-right">
              <p>Mon – Fri: 9am – 7pm</p>
        ...
        <div className="copper-line mt-14 mb-8 opacity-20" />
