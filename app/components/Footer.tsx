      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "64px 24px" }}>
        <div className="grid grid-cols-1 md:grid-cols-3" style={{ gap: "48px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            />
            <p className="text-cream-dim text-sm leading-relaxed" style={{ maxWidth: "300px" }}>
            ...
            <a
              ...
              className="flex items-center gap-3 text-cream-dim hover:text-copper transition-all duration-300 text-sm group"
            >
          ...
          {/* Quick Links */}
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }} className="md:items-center">
          ...
          {/* Hours */}
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }} className="md:items-end md:text-right">
            <h4 className="text-copper text-[11px] tracking-[0.3em] uppercase font-semibold">
              Hours
            </h4>
